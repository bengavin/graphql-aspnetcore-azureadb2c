  ...
  return (
    <div>
      ...
      <p>
        ...
        a GraphQL API, and secured with Azure AD B2C.  Please see <a href="https://www.virtual-olympus.com/2022/12/securing-graphql-azureadb2c-1">this blog post</a> for
